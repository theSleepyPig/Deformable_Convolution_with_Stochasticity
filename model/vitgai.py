...
class VisionTransformer2(nn.Module):
    ...
    def __init__(
        ...
        if conv_stem_configs is not None:
            ...
            self.conv_proj = MaskedConv2d(
                in_channels=3, out_channels=hidden_dim, kernel_size=patch_size, stride=patch_size - 1
            )
...
@register_model()
@handle_legacy_interface(weights=("pretrained", ViT_B_16_Weights.IMAGENET1K_V1))
def vit_b_16_mask(*, weights: Optional[ViT_B_16_Weights] = None, progress: bool = True, **kwargs: Any) -> VisionTransformer:
