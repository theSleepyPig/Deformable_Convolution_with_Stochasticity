...
class VarBasicBlock2(nn.Module):
    '''BasicBlock.'''
    expansion = 1
    def __init__(self, in_planes, planes, stride=1):
        super(VarBasicBlock, self).__init__()
...
class ResNetmask(nn.Module):
    ...
    def set_rand_mask(self):
        ...
        # top = [(0, 0), (0, 1), (1, 0), (1, 1), (2, 0), (2, 1), (3, 0), (3, 1), (4, 0), (4, 1), (3, 2), (4, 2)]
        # bottom = [(0, 3), (0, 4), (1, 3), (1, 4), (0, 2), (1, 2), (3, 3), (3, 4), (4, 3), (4, 4), (2, 3), (2, 4)]
        
        top = [(2, 2), (0, 0), (0, 1), (1, 0), (1, 1), (2, 0), (2, 1), (3, 0), (3, 1), (4, 0), (4, 1), (3, 2), (4, 2), (0, 3), (0, 4), (1, 3), (1, 4), (0, 2), (1, 2), (3, 3), (3, 4), (4, 3), (4, 4), (2, 3), (2, 4)]
        
        # #2in5
        # left_top = [(0, 0), (0, 1), (1, 0), (2, 0), (2, 1)]
        # right_top = [(0, 3), (0, 4), (1, 4), (0, 2), (1, 2)]
        # left_bottom = [(3, 0), (4, 0), (4, 1), (3, 2), (4, 2)]
        # right_bottom = [(3, 4), (4, 3), (4, 4), (2, 3), (2, 4)]
        
        # #2in4
        # left_top = [(0, 0), (0, 1), (1, 0), (2, 0)]
        # right_top = [(0, 3), (0, 4), (1, 4), (0, 2)]
        # left_bottom = [(3, 0), (4, 0), (4, 1), (4, 2)]
        # right_bottom = [(3, 4), (4, 3), (4, 4), (2, 4)]        

        selected_top = np.random.choice(len(top), 3, replace=False)
        # selected_bottom = np.random.choice(len(bottom), 1, replace=False)
        ...
        if not self.mask_printed:  # 只在第一次调用时打印
            print(mask)
            self.mask_printed = True
...
class ResNetpath(nn.Module):
    def __init__(self, block, num_blocks, device, num_classes=10, normalize=None):
        ...
        self.in_planes = 64
        self.conv1_layers = nn.ModuleList([MaskedConv2d(3, 64, kernel_size=5, stride=1, padding=2, bias=False, device=device , mask=generate_masks()) for _ in range(2)])
        self.bn1 = BatchNorm2d(64)
        self.layer1 = self._make_layer(block, 64, num_blocks[0], stride=1)
        self.layer2 = self._make_layer(block, 128, num_blocks[1], stride=2)
        self.layer3 = self._make_layer(block, 256, num_blocks[2], stride=2)
...
def ResNet18(num_classes=10, normalize=None, device = torch.device(0), pos = 0, eot = False, lb = 2048):
    return ResNet3(VarBasicBlock, BasicBlock, [1,1,2,2,2], normalize = normalize, num_classes=num_classes)

def ResNet18_2(num_classes=10, normalize=None, device = torch.device(0), pos = 0, eot = False, lb = 2048):
    mask= generate_mask()
    # print(mask)
    return ResNetmask( BasicBlock, [2,2,2,2], mask=mask, normalize = normalize, num_classes=num_classes, device = device)

def ResNet18_3(num_classes=10, normalize=None, device = torch.device(0), pos = 0, eot = False, lb = 2048):
    return ResNetpath( BasicBlock, [2,2,2,2], normalize = normalize, num_classes=num_classes, device = device)