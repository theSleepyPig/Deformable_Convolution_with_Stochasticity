...
from validation_mask import validate, validate_pgd, validate_pgd_random, validate_random, validate_pgd_mask, validate_mask, validate_pgd_mask50
import torchvision.models as models
from model.first_resnet_imagenet_mask2 import ResNet50
...
def parse_args():
    ...
    parser.add_argument('--wandb_project', default='frozenimagenet', type=str, help='WandB project name')
...
def main():
    ...
    for epoch in range(config.TRAIN.start_epoch, config.TRAIN.epochs):
        ...
        if is_best:
            ...
            if config.adv_train:
                best_pgd_acc_k50 = validate_pgd_mask50(val_loader, model, criterion, 50, 1.0 / 255.0, config, logger)
            else:
