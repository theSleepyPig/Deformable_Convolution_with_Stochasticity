...
from validation_mask import validate, validate_pgd, validate_pgd_random, validate_random, validate_pgd_mask, validate_mask
...
def main():
    ...
    os.environ['CUDA_VISIBLE_DEVICES'] = str('0, 1, 2')
    ...
    for epoch in range(config.TRAIN.start_epoch, config.TRAIN.epochs):
        ...
        if is_best:
            ...
            if config.adv_train:
                best_pgd_acc_k50 = validate_pgd_mask(val_loader, model, criterion, 50, 1.0 / 255.0, config, logger)
            else:
