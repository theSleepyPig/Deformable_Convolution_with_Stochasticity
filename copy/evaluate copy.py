...
# normalize=dataset_normalization,
    ...
    evaluate_attack(device, model, test_loader, args, atk, 'eotpgd', logger)
    ...
    evaluate_attack(device, model, test_loader, args, atk, 'pixel', logger)

    print('Square attacking')
    atk = torchattacks.Square(model, eps=8/255, n_queries=5000, p_init=0.8, loss='ce')
    evaluate_attack(device, model, test_loader, args, atk, 'square', logger)
