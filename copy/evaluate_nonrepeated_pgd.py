...
def get_args():
    ...
    parser.add_argument('--pretrain', default=os.path.abspath('ckpt/cifar100/WideResNet34/ckpt/weight_20240930154844.pth'), type=str, help='Path to load the pretrained model')
...
def main():
    ...
    wandb.init(project='-Test-3', entity='xuanzhu_07-university-of-sydney', reinit=True, config=args)
    config = wandb.config   
