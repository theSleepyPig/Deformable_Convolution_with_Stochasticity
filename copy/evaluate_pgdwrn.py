...
def get_args():
    ...
    parser.add_argument('--network', default='WideResNet34', choices=['ResNet18', 'WideResNet34'], type=str)
    ...
    parser.add_argument('--randpos_multi_deform_training', action='store_true', default=True,
    ...
    parser.add_argument('--pretrain', default=os.path.abspath('ckpt/cifar10/WideResNet34/ckpt/model_20240804095409.pth'), type=str, help='Path to load the pretrained model')
    #这里ckpt/cifar10/ResNet18/ckpt/weight_20240808163553.pth
...
def main():
    ...
    device = torch.device(0)
     ...
     # 初始化 wandb
    wandb.init(project='-Test-pgd-wrn', entity='xuanzhu_07-university-of-sydney', reinit=True, config=args)
    config = wandb.config   
