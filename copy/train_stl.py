...
from utils import (upper_limit, lower_limit, std, clamp, get_loaders, load_model, get_loaders96)
#import torchvision
...
def get_args():
    ...
    parser.add_argument('--dataset', default='cifar10', choices=['cifar10', 'cifar100','tiny-imagenet','stl10'])
...
def main():
    ...
    # 初始化 wandb
    wandb.init(project='stl', entity='xuanzhu_07-university-of-sydney', reinit=True, config=args)
    config = wandb.config
    ...
    # get data loader
    train_loader, test_loader, dataset_normalization = get_loaders96(args.data_dir, args.batch_size,
