...
def get_args():
    ...
    parser.add_argument('--pretrain', default=os.path.abspath('ckpt/cifar10/ResNet18/ckpt/model_20240911134608.pth'), type=str, help='Path to load the pretrained model')
    #这里hzx/rand_defence/ckpt/cifar10/ResNet18/ckpt/model_20240910092612.pth 20240911134847
...
def main():
    ...
    device = torch.device(args.device)
     ...
     # 初始化 wandb
    wandb.init(project='-Test-R18-C10-4-1-nonrepeated', entity='xuanzhu_07-university-of-sydney', reinit=True, config=args)
    # wandb.init(project='-Test-R18-C10-4-1-nonrepeated', entity='xuanzhu_07-university-of-sydney', reinit=True, config=args)
    config = wandb.config   
