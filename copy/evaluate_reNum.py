...
def get_args():
    ...
    parser.add_argument('--pretrain', default=os.path.abspath('/mnt/ssd_2/yxma/ckpts/DCS/ckpt/cifar10/ResNet18/ckpt/model_20240925004445.pth'), type=str, help='Path to load the pretrained model')
    #这里hzx/rand_defence/ckpt/cifar100/ResNet18/ckpt/model_20240911134608.pth 20240911134847
    # "/mnt/ssd_2/yxma/ckpts/DCS/ckpt/cifar10/ResNet18/ckpt/model_20240925004445.pth"
...
def main():
    ...
    wandb.init(project='-Test-reNUM', entity='xuanzhu_07-university-of-sydney', reinit=True, config=args)
    config = wandb.config   
