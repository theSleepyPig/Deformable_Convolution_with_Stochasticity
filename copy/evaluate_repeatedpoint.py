...
def get_args():
    ...
    parser.add_argument('--pretrain', default=os.path.abspath('ckpt/cifar100/WideResNet34/ckpt/model_20240930154844.pth'), type=str, help='Path to load the pretrained model')
    #0这里model_20240923021823
    #1:20240922033656
    #2:20240924035003,20240923021758, 20240922033712
    #3:20240924040248
    #4:20240922033744
    #/home/yxma/hzx/hzx/rand_defence/ckpt/cifar100/WideResNet34/ckpt/model_20240930154844.pth
...
def main():
    ...
    wandb.init(project='-Test-numOfRepeated2Point-c10-r18-4layer', entity='xuanzhu_07-university-of-sydney', reinit=True, config=args)
    config = wandb.config   
...
# normalize=dataset_normalization,
    ...
    pgd_acc = evaluate_attack(device, model, test_loader, args, atk, 'pgd', logger, repeat=10)
