...
def load_randpos_deform(name):
    if name == 'ResNet18':
        from model.randpos_resnet import ResNet18_2
        return ResNet18_2
...
def load_multi_rand_deform(name):
    if name == 'ResNet18':
        ...
        from model.resnet_50 import ResNet50_mask
        return ResNet50_mask
    ...
    if args.none_random_training:
        if args.rand_deform_training:
            ...
            if args.randpos_multi_deform_training:
                ...
                return load_randpos_deform(args.network)
