...
from utils import (upper_limit, lower_limit, std, clamp, get_224loaders, load_model)
#import torchvision
...
def get_args():
    ...
    parser.add_argument('--network', default='Vit', choices=['ResNet18', 'WideResNet34','ResNet50','Vit'], type=str)
