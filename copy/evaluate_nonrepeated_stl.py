...
from utils import evaluate_standard, evaluate_standard_random_weights, get_loaders, get_loaders96, get_loaders_mnist28, load_model, evaluate_standard_random_mask,  get_loaders_mnist
...
def main():
    ...
    wandb.init(project='-Test-stlmnist', entity='xuanzhu_07-university-of-sydney', reinit=True, config=args)
    config = wandb.config   
    ...
    train_loader, test_loader, dataset_normalization = get_loaders_mnist28(args.data_dir, args.batch_size, dataset=args.dataset,
    ...
    evaluate_attack(device, model, test_loader, args, atk, 'autoattack', logger, repeat=3)
